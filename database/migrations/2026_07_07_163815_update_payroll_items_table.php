...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('payroll_items', function (Blueprint $table) {
            // Replace single allowance with specific allowances
            $table->dropColumn('allowance');

            $table->decimal('transpo_allowance', 10, 2)->default(0)->after('basic_pay');
            ...
            $table->decimal('absent_deduction', 10, 2)->default(0)->after('overtime_pay');
    ...
    public function down(): void
    {
        Schema::table('payroll_items', function (Blueprint $table) {
            ...
            $table->decimal('allowance', 10, 2)->default(0)->after('basic_pay');
        });
    }
};
