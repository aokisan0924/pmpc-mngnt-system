export function Button({
    ...
    }[size] || 'text-sm px-4 py-2 gap-2 h-10'
    ...
    const variantClasses = {
        ...
        danger: 'bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white shadow-xs focus-visible:outline-rose-600 dark:bg-rose-500 dark:hover:bg-rose-600',
